...
[
        InlineKeyboardButton(
            text="SALAM OWNER", callback_data="kynan_jasa"
        ),
     ],
     [
        InlineKeyboardButton(
...
def kynan_about_callback(update, context):
    ...
    if query.data == "kynan_":
        ...
        query.message.edit_text(
            text="𝙎𝘼𝙇𝘼𝙈 𝙎𝙀𝙅𝘼𝙃𝙏𝙀𝙍𝘼"
            "\n\n ꜱᴀʟᴀᴍ ꜱᴇᴊᴀʜᴛᴇʀᴀ ʙᴜᴀᴛ ᴋᴀʟɪᴀɴ ꜱᴇᴍᴜᴀ."
            "\n\n ꜱɪʟᴀʜᴋᴀɴ ᴘᴀᴋᴀɪ ʙᴏᴛ ᴍᴜꜱɪᴋ ɪɴɪ"
            "\n ꜱᴇꜱᴜᴋᴀ ʜᴀᴛɪ ᴋᴀʟɪᴀɴ."
            "\n ᴍᴀꜱᴜᴋᴀɴ ʙᴏᴛ ɪɴɪ ᴋᴇ ɢʀᴏᴜᴘ ᴄʜᴀᴛ"
            "\n ᴀᴛᴀᴜ ᴄʜᴀɴɴᴇʟ ᴋᴀʟɪᴀɴ."
            "\n\n ʙɪꜱᴀ ʙᴜᴀᴛ ᴘʟᴀʏ ᴍᴜꜱɪᴋ, ᴠɪᴅᴇᴏ,"
            "\n ᴍᴇɴɢᴀᴛᴜʀ ɢʀᴏᴜᴘ ᴄʜᴀᴛ ᴋᴀʟɪᴀɴ"
            "\n ᴅᴇɴɢᴀɴ ʀᴀᴘɪ."
            "\n\n ᴀᴘᴀʙɪʟᴀ ᴛᴇʀᴊᴀᴅɪ ᴇʀᴏʀ, ꜱɪʟᴀʜᴋᴀɴ"
            "\n ʟᴀᴘᴏʀᴋᴀɴ ᴋᴇᴘᴀᴅᴀ ᴏᴡɴᴇʀ."
            "\n\n ꜱᴀʟᴀᴍ ꜱᴇᴊᴀʜᴛᴇʀᴀ"
            "\n ᴛᴛᴅ",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
